    ...
    <SiteLayout>
      <section className="relative overflow-hidden bg-primary-dark pt-36 pb-16 text-white md:pt-48 md:pb-20">
        ...
        <div className="container-page relative max-w-3xl">
          ...
          <h1 className="text-3xl font-bold text-white! md:text-4xl">Terms and Conditions</h1>
          ...
          <p className="mt-5 max-w-2xl text-white/75 leading-relaxed">
            These Terms and Conditions govern your use of the {COMPANY_NAME} website and the basis
            on which we provide information about our construction and contracting services in
            Kuwait. Please read them carefully before using our website.
          </p>
        </div>
      </section>
